export default [
  { name: 'Apache Hive', type: 'apache-hive' },
  { name: 'Apache Phoenix', type: 'apache-phoenix' },
  { name: 'Apache Spark', type: 'apache-spark' },
  { name: 'Azure SQL', type: 'azure-sql' },
  { name: 'Drill', type: 'drill' },
